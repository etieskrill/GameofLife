...
public class NativeIOTest {
    ...
    * below, relative. Canonical is like absolute, but a little formatted, and relative takes not the system root, but
    * the project folder as the current root. Relative paths are also written using forward slashes instead of the
    * backward ones. A file object can be made from any file type. After construction, the file is completely
    * independent of the source it may have originated from. A file can also create a new file for a given path, delete
    * it, and get its attributes. A file can consist of a nested folder structure, and so is more or less what one could
    * expect from a file/folder in the explorer.*/

    static File file = new File("GOL-core/src/com/gol/Test/test.txt");
    ...
    * other method.*/
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Can execute: " + file.canExecute()); //TODO wtf is the criteria for executable, coz dis clearly not meant to be
